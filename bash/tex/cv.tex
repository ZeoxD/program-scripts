...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Divyanshu Tripathi \vspace{1pt}} & % row = 1, col = 1
  \\ % row = 1, col = 2
  \\
...
\section{Courses / Certifications}
  \resumeItemListStart{}
    ...
    \resumeItem{\href{https://drive.google.com/file/d/1Rph8aae0uFP727dcrdPL03RoO5Nnq1rE/view}{\color{blue}{Koenig Solutions: Linux Fundamentals}}}
    \resumeItem{{Udemy: Build Web Apps with React and Firebase | The Net Ninja}}
    \resumeItem{{Udemy: Node.js, Express, MongoDB and More: The Complete Bootcamp 2023 | Jonas Schmedtmann}}
...
\section{Achievements}
  \resumeItemListStart{}
    \resumeItem{{350+ questions in} \href{https://leetcode.com/zeoxd}
    {\color{blue}{Leetcode}}}
